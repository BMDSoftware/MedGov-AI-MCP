...
Inference performance is tightly coupled to available hardware, and the gap between CPU and GPU execution has direct clinical implications. Table~\ref{tab:inference-timing} summarises the observed timing data.
...
\begin{table*}[t]
  ...
  \begin{tabular}{lllll}
    ...
    Cellpose v4 (cpsam) & CPU & Real ROI image & $\sim$3h (hung) & -- \\
